...
export default function ConversationRow({ data, active, onSelect, onTogglePin, showMeta }) {
  ...
  return (
    <div className="group relative -mx-1 flex w-[calc(100%+8px)] items-center gap-2 rounded-lg">
      <button
        onClick={onSelect}
        className={cls(
          "flex flex-1 items-center gap-2 px-2 py-2 text-left rounded-lg",
          active
      ...
      <button
        ...
        className="rounded-md p-1 text-zinc-500 opacity-0 transition group-hover:opacity-100 hover:bg-zinc-200/50 dark:text-zinc-300 dark:hover:bg-zinc-700/60 shrink-0"
